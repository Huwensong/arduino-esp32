...
int jsmi_get_value_uint(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                        unsigned int *value);

int jsmi_get_value_sint(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                        int *value);

int jsmi_get_value_str(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                       char *str, size_t str_size);

int jsmi_get_value_bool(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                        bool *value);

int
jsmi_get_value_double(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      double *value);

int
jsmi_get_value_uint64(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      uint64_t *value);

int
jsmi_get_value_sint64(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      int64_t *value);
...
int
jsmi_get_value_uint32(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      uint32_t *value);

int
jsmi_get_value_sint32(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      int32_t *value);
...
int
jsmi_get_value_uint16(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      uint16_t *value);

int
jsmi_get_value_sint16(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                      int16_t *value);

#define jsmi_get_value_u16    jsmi_get_value_uint16
#define jsmi_get_value_s16    jsmi_get_value_sint16

int jsmi_get_value_uint8(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                         uint8_t *value);

int jsmi_get_value_sint8(jsmi_parser_t *parser, jsmntok_t *parent_tok, jsmi_tok_path_t *tok_path, size_t tok_path_depth,
                         int8_t *value);
