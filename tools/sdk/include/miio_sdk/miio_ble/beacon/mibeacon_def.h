...
#define MAX_REPORT_ID_IN_PID                                15                      //support one auth dev support the max mibeacon object record
#define MAX_OBJECT_ID_IN_PID                                MAX_REPORT_ID_IN_PID    //the max object num of  one obj dev support ? 7
#define MAX_SPEC_ID_IN_PID                                  MAX_REPORT_ID_IN_PID    //the max prop + event type of one spec dev support
...
#define MAX_AUTHED_DEV_LIST_COUNT                           25  //the max num of auth dev
#define MAX_UNKNOWN_DEV_LIST_COUNT                          255
#define MAX_DENIED_DEV_LIST_COUNT                           50
#define MAX_MIBAND_DEV_LIST_COUNT                           10
#define MAX_KEEP_ALIVE_DEV_LIST_COUNT                       MAX_AUTHED_DEV_LIST_COUNT
#define MAX_RPC_UPLOAD_LIST_COUNT                           50

#define QUERY_DEV_INTERVEL_S                                10  //10s send qurey dev
#define QUERY_DEV_MAX_COUNT                                 30  //the max num of  one time send
#define QUERY_DEV_RPC_COUNT                                 4   //devices in query_dev_list

#define MAX_OBJECT_RULE_LIST_COUNT                          175 //the max pid and obj ID rule of one GW support(25*7)
#define MAX_PID_OBJ_ID_LIST_COUNT                           MAX_AUTHED_DEV_LIST_COUNT   //the max obj dev type  of one GW support
#define MAX_UNKNOWN_PID_LIST_COUNT                          255
#define MAX_PID_SPEC_ID_LIST_COUNT                          MAX_AUTHED_DEV_LIST_COUNT   //the max spec dev type  of one GW support
