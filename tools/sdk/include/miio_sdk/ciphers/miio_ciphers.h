...
#define KV_PKCS7_BASE           16      //  AES128
...
int miio_encrypt_kv(const uint8_t *plnvalue, size_t plnvaluelen, uint8_t **out_cipvalue);
int miio_decrypt_kv(const uint8_t *cipvalue, size_t cipvaluelen, uint8_t **out_plnvalue);
#endif
