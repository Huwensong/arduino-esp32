...
typedef int (*mible_net_recovery_callback_t)(miio_handle_t miio_handle, uint8_t recovery_flag); 

typedef struct {
    mible_net_config_callback_t config_callback;
    mible_net_restore_callback_t restore_callback;
    mible_net_recovery_callback_t recovery_callback;
...
int mible_net_event_callback(miio_net_event_e net_event, void *ctx);
#endif
