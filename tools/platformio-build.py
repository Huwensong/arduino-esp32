...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lesp_gdbstub", "-lconsole", "-lesp_http_client", "-lmqtt", "-lmbedtls", "-lesp_event", "-lgpio_button", "-lbtdm_app", "-lesp-tls", "-lpp", "-lrtc", "-lesp32-camera", "-lcoap", "-lesp_local_ctrl", "-lhuman_face_detect", "-lexpat", "-lefuse", "-llwip", "-lheap", "-lnewlib", "-ldl", "-lunity", "-lhal", "-lsoc", "-lsdmmc", "-ltcpip_adapter", "-lmdns", "-lcxx", "-lphy", "-lfreertos", "-lcolor_detect", "-ltcp_transport", "-lbootloader_support", "-lesp_rom", "-ldriver", "-lsmartconfig", "-lesp32", "-lesp_adc_cal", "-lfb_gfx", "-lcat_face_detect", "-lnvs_flash", "-lesp_eth", "-ljson_generator", "-lfatfs", "-lesp_websocket_client", "-lesp_https_ota", "-lwear_levelling", "-lnet80211", "-lprotocomm", "-lcore", "-lxtensa", "-lm", "-lapp_trace", "-lspiffs", "-lnghttp", "-lwifi_provisioning", "-ljsmn", "-lesp_ringbuf", "-ljson", "-lesp_wifi", "-lesp_rainmaker", "-lmesh", "-llog", "-lws2812_led", "-lesp_schedule", "-lqrcode", "-lpthread", "-lprotobuf-c", "-lspi_flash", "-lulp", "-ljson_parser", "-lmfn", "-lapp_update", "-lesp_common", "-llibsodium", "-lwpa_supplicant", "-lasio", "-lvfs", "-lfreemodbus", "-lrmaker_common", "-lesp_http_server", "-lespcoredump", "-lopenssl", "-lespnow", "-lcoexist", "-lc", "-lstdc++"
    ],
